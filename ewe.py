    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/Mang engkur smd')
                time.sleep(2)
                menu()
